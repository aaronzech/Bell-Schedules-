...
// Justice League 2019SY
public class omsTeam6 extends AppCompatActivity {

    static String ADVISORY_START = "08:10:00";
    static String ADVISORY_END = "08:51:00";

    static String EXPLORE2_START = "08:55:00";
    static String EXPLORE2_END = "09:36:00";

    static String CORE_1_START = "09:40:00";
    static String CORE_1_END = "10:36:00";

    static String CORE_2_START = "10:40:00";
    static String CORE_2_END = "11:21:00";
    ...
    public static final String TEAM_NAME = "Justice League";
    ...
    private void printSchedule()
    {
        ...
        hour1TextView.setText("Advisory"+ " 8:10-8:51");
        hour2TextView.setText("Explore 2"+ " 8:55-9:36");
        hour3TextView.setText(PREF +"1"+ " 9:40-10:36");
        hour4TextView.setText(PREF+"2"+ "10:40-11:21");
        hour5TextView.setText("Lunch B"+ " 11:25-11:51");
        hour6TextView.setText("Explore 4"+" 11:55-12:36");
        hour7TextView.setText(PREF+"3"+ " 12:40-1:36");
        hour8TextView.setText(PREF+"4"+" 1:40-2:40");
    ...
    {
        startActivity(new Intent(omsTeam6.this,omsSelect.class));
    }
