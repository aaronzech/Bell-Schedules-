...
// Avengers + Teen Titans 2019SY
public class omsTeam5 extends AppCompatActivity {

    static String CORE_1_START = "08:10:00";
    static String CORE_1_END = "08:50:00";

    static String EXPLORE2_START = "08:55:00";
    static String EXPLORE2_END = "09:36:00";

    static String CORE_2_START = "09:40:00";
    static String CORE_2_END = "10:36:00";

    static String CORE_3_START = "10:40:00";
    static String CORE_3_END = "11:36:00";

    static String CORE_4_START = "11:40:00";
    static String CORE_4_END = "12:36:00";

    static String LUNCH_START = "12:40:00";
    static String LUNCH_END = "13:06:00";

    static String EXPLORE5_START = "13:10:00";
    static String EXPLORE5_END = "13:51:00";
    ...
    public static final String TEAM_NAME = "Avengers+Teen Titans";
    ...
    private void printSchedule()
    {
        ...
        hour1TextView.setText(PREF +"1"+ " 8:10-8:51");
        hour2TextView.setText("Explore 2"+ " 8:55-9:36");
        hour3TextView.setText(PREF +"2"+ " 9:40-10:36");
        hour4TextView.setText(PREF+"3"+ "10:40-11:36");
        hour5TextView.setText(PREF+"4"+" 11:40-12:36");
        hour6TextView.setText("Lunch D"+ " 12:40-1:06");
        hour7TextView.setText("Explore 5"+" 1:10-1:51");
        hour8TextView.setText("Advisory"+ " 1:55-2:40");
    ...
    {
        startActivity(new Intent(omsTeam5.this,omsSelect.class));
    }
    ...
    private void whatHourIsIt(String currentTime)
    {
        ...
        try {
            ...
            else if (x.after(analyzer.analizeTime(EXPLORE5_START)) && x.before(analyzer.analizeTime(EXPLORE5_END)))
            {
                hour = "EXPLORE 5";
            }
            ...
            else if (x.after(analyzer.analizeTime(EXPLORE2_START)) && x.before(analyzer.analizeTime(EXPLORE2_END)))
            {
                hour = "EXPLORE 2";
            }
