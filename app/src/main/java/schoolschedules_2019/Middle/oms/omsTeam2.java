...
// Mavericks 2019SY
public class omsTeam2 extends AppCompatActivity {
    ...
    static String CORE_3_END = "11:51:00";

    static String ADVISORY_START = "11:55:00";
    static String ADVISORY_END = "12:36:00";

    static String LUNCH_START = "12:40:00";
    static String LUNCH_END = "13:06:00";

    static String EXPLORE5_START = "13:10:00";
    static String EXLPORE5_END = "13:51:00";
    ...
    public static final String TEAM_NAME = "Mavericks";
    ...
    /**
     * Sets up TextView Displays with current text
     */
    ...
    {
        startActivity(new Intent(omsTeam2.this,omsSelect.class));
    }
    ...
    private void printSchedule()
    {
        ...
        hour3TextView.setText(PREF+"3"+ " 10:40-11:51");
        hour4TextView.setText("Advisory"+ " 11:55-12:36");
        hour5TextView.setText("Lunch D" +" 12:40-1:06");
        hour6TextView.setText("Explore 5"+ " 1:10-1:51");
        hour7TextView.setText("Explore 6"+" 1:55-2:40");
    ...
    private void whatHourIsIt(String currentTime)
    {
        ...
        try {
            ...
            //Hour 1 check
            if(x.after(analyzer.analizeTime(EXPLORE5_START)) && x.before(analyzer.analizeTime(EXLPORE5_END)))
            {
                hour = "Explore 5";
            }
