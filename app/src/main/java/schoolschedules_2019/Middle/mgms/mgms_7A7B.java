...
public class mgms_7A7B extends AppCompatActivity {
    ...
    static String EXPLORATORY_2_START = "12:17:00";
    static String EXPLORATORY_2_END = "13:02:00";
    ...
    private void printSchedule()
    {
        ...
        hour6TextView.setText("Exploratory 2"+  " 12:17-1:02");
    ...
    {
        startActivity(new Intent(mgms_7A7B.this,mgmsSelect.class));
    }
