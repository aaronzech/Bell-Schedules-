...
// Team 7AB, 8CD
public class mgms_6C6D extends AppCompatActivity {
    ...
    static String LUNCH_END = "11:03:00";

    static String ADVISORY_FLEX_START = "11:08:00";
    static String ADVISORY_FLEX_END = "11:48:00";
    ...
    {
        startActivity(new Intent(mgms_6C6D.this,mgmsSelect.class));
    }
